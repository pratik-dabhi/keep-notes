...
const Dropdown = ({children,setShowDropdown}:TDropDownProps) => {
  ...
  return (
      <div className={`absolute mt-8 start-8 w-1/5 transition-opacity duration-200 opacity-100 min-w-60 bg-white shadow-md rounded-lg p-1 space-y-0.5 mt-2 dark:bg-neutral-800`}>
        <div className="">
