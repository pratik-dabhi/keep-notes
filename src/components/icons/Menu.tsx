...
const Menu = () => {
  return (
    <>
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" width={26} height={26} x={0} y={0} viewBox="0 0 24 24" style={{background: 'new 0 0 512 512'}} xmlSpace="preserve">
        <g>
          <g fill="currentColor">
