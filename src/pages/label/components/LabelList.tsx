    ...
    <>
        ...
        <li>
            <div className="flex items-center">
                <input id={`${label.id}`} data-name={label.name} type="checkbox" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded" onChange={e=>updateLabelHandler(e)} checked={isChecked}/>
