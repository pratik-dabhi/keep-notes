...
const Login = () => {
  return (
    <>
      <Seo title='Login' metaDescription='Login Page'/>
      
      <div className="md:py-16 lg:py-28 min-h-screen">
        <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
          ...
          <div className="w-full p-8 lg:w-1/2">
            <h2 className="text-2xl font-semibold text-gray-700 text-center">{import.meta.env.VITE_APP_NAME}</h2>
            ...
            <div className="mt-4">
              <p className='px-4 py-3 w-100 text-center'>Don't have an account? <a href="#" className='text-gray-600 font-bold'>Sign Up</a></p>
            </div>
          </div>
        </div>
      </div>
